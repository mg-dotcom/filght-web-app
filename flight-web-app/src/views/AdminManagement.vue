<template>
  ...
  const admins = reactive([
    { id: 1, name: 'Jane Doe',   email: 'jane@example.com',   role: 'Super Admin',   status: 'Online'  },
    { id: 2, name: 'John Smith', email: 'john@example.com',   role: 'Flight Admin',  status: 'Offline' },
    { id: 3, name: 'Emily Chen', email: 'emily@example.com',  role: 'User Admin',    status: 'Online'  },
    { id: 4, name: 'Michael Lee',email: 'michael@example.com',role: 'Finance Admin', status: 'Offline' }
  ])
  ...
  .table-row {
    ...
    padding:10px 20px; border-bottom:1px dashed #ccc;
  }
  .table-row.table-head {
    font-weight:bold; background:#f5f5f5; border-bottom:2px solid #ddd;
    grid-template-columns:1.5fr 2fr 1.5fr 1fr 1fr;
  }
  .admins .table-row { grid-template-columns:1.5fr 2fr 1.5fr 1fr 1fr; }
  .status {
